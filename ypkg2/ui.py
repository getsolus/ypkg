...
class YpkgUI:
    ...
    def emit_error(self, key, error):
        ...
        if not self.allow_colors:
            ...
            print(
                (
                    f"{AnsiColors.RED}[{key}]{AnsiColors.RESET} {AnsiColors.BOLD}{error}{AnsiColors.RESET}"
                )
            )
    ...
    def emit_warning(self, key, warn):
        ...
        if not self.allow_colors:
            ...
            print(
                (
                    f"{AnsiColors.YELLOW}[{key}]{AnsiColors.RESET} {AnsiColors.BOLD}{warn}{AnsiColors.RESET}"
                )
            )
    ...
    def emit_info(self, key, info):
        ...
        if not self.allow_colors:
            ...
            print(f"{AnsiColors.BLUE}[{key}]{AnsiColors.RESET} {info}")
    ...
    def emit_success(self, key, success):
        ...
        if not self.allow_colors:
            ...
            print(f"{AnsiColors.GREEN}[{key}]{AnsiColors.RESET} {success}")
